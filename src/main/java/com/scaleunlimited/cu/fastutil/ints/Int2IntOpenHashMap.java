 ...
 */
package com.scaleunlimited.cu.fastutil.ints;
import static com.scaleunlimited.cu.fastutil.HashCommon.arraySize;
import static com.scaleunlimited.cu.fastutil.HashCommon.maxFill;

import java.util.Map;
import java.util.NoSuchElementException;

import com.scaleunlimited.cu.fastutil.Hash;
import com.scaleunlimited.cu.fastutil.HashCommon;
import com.scaleunlimited.cu.fastutil.booleans.BooleanArrays;
import com.scaleunlimited.cu.fastutil.ints.AbstractIntCollection;
import com.scaleunlimited.cu.fastutil.ints.IntCollection;
import com.scaleunlimited.cu.fastutil.ints.IntIterator;
import com.scaleunlimited.cu.fastutil.objects.AbstractObjectSet;
import com.scaleunlimited.cu.fastutil.objects.ObjectIterator;
...
public class Int2IntOpenHashMap extends AbstractInt2IntMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public int put(final int k, final int v) {
  // The starting point.
  int pos = ( com.scaleunlimited.cu.fastutil.HashCommon.murmurHash3( (k) ^ mask ) ) & mask;
 ...
 protected final int shiftKeys( int pos ) {
  ...
  for(;;) {
   pos = ( ( last = pos ) + 1 ) & mask;
   while( used[ pos ] ) {
    slot = ( com.scaleunlimited.cu.fastutil.HashCommon.murmurHash3( (key[ pos ]) ^ mask ) ) & mask;
 ...
 protected void rehash( final int newN ) {
  ...
  for( int j = size; j-- != 0; ) {
   while( ! used[ i ] ) i++;
   k = key[ i ];
   pos = ( com.scaleunlimited.cu.fastutil.HashCommon.murmurHash3( (k) ^ mask ) ) & mask;
