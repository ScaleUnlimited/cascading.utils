...
public class IntIterators {
 ...
 protected static class ByteIteratorWrapper implements IntIterator {
  final com.scaleunlimited.cu.fastutil.bytes.ByteIterator iterator;
  public ByteIteratorWrapper( final com.scaleunlimited.cu.fastutil.bytes.ByteIterator iterator ) {
 ...
 /** Returns an iterator backed by the specified byte iterator. 
	 ...
	 */
 public static IntIterator wrap( final com.scaleunlimited.cu.fastutil.bytes.ByteIterator iterator ) {
 ...
 protected static class ShortIteratorWrapper implements IntIterator {
  final com.scaleunlimited.cu.fastutil.shorts.ShortIterator iterator;
  public ShortIteratorWrapper( final com.scaleunlimited.cu.fastutil.shorts.ShortIterator iterator ) {
   this.iterator = iterator;
  }
  public boolean hasNext() { return iterator.hasNext(); }
 ...
 /** Returns an iterator backed by the specified short iterator. 
	 ...
	 */
 public static IntIterator wrap( final com.scaleunlimited.cu.fastutil.shorts.ShortIterator iterator ) {
