package com.scaleunlimited.cu.fastutil;
 ...
 * for all type-specific maps to extend type-specific functions (e.g., {@link com.scaleunlimited.cu.fastutil.ints.Int2IntMap}
 * extends {@link com.scaleunlimited.cu.fastutil.ints.Int2IntFunction}). However, {@link #size()} is allowed to return -1 to denote
