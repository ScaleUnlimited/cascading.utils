...
/**
 * Tests MiniDFS cluster setup/teardown and isolation. Every instance is brought
 * up with a new data dir, to ensure that shutdown work in background threads
 * don't interfere with bringing up the new cluster.
 */
public class TestMiniDFSCluster {
    ...
    @Before
    public void setUp() {
        testDataPath = new File("build/test/TestMiniDFSCluster/");
    }

    /**
     * Verify that without system properties the cluster still comes up,
     * provided the configuration is set
     * 
     * @throws Throwable
     *             on a failure
     */
